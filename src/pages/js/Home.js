        ...
        <div className='content'>
          ...
          <div className='relative'>
              ...
              <div className='my-24 mx-10 '>
                ...
                <p className="text-sm">MD Autohunt không chỉ là một nền tảng kết nối khách hàng với những mẫu xe chất lượng mà còn là một thương hiệu tiên phong trong ngành công nghiệp ô tô. Chiến lược của chúng tôi tập trung vào ba yếu tố cốt lõi: Công nghệ, Dịch vụ và Uy tín.</p>
                <p className="text-sm">Về công nghệ, chúng tôi liên tục nâng cấp hệ thống, sử dụng trí tuệ nhân tạo và dữ liệu lớn để tối ưu trải nghiệm tìm kiếm xe. Về dịch vụ, MD Autohunt cam kết mang lại sự minh bạch, hỗ trợ tận tình và quy trình giao dịch nhanh chóng. Uy tín của chúng tôi được xây dựng qua từng sản phẩm, từng khách hàng hài lòng và từng đánh giá tích cực.</p>
                <p className="text-sm">Với tầm nhìn dài hạn, MD Autohunt sẽ tiếp tục mở rộng mạng lưới, hợp tác với các đối tác hàng đầu trong ngành để mang đến trải nghiệm mua bán xe hiệu quả, an toàn và đáng tin cậy nhất.</p>
              </div>
          </div>
        </div>
